<div class="left-sidebar bg-black-300 box-shadow;" style="background-color:#4a909e;">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="❤️" class="img-circle profile-img">
...
<li class="has-children">
                                        ...
                                        <li><a href="change-password.php"><i class="fa fa fa-server"></i> <span> Admin Change PW</span></a></li>
